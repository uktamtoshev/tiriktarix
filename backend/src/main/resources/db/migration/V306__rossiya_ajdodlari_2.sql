...
('vernadskiy', 'RU', 33, 'Владимир Вернадский', 'Vladimir Vernadskiy',
...
('kapitsa', 'RU', 33, 'Пётр Капица', 'Pyotr Kapitsa',
...
('muhina', 'RU', 33, 'Вера Мухина', 'Vera Muxina',
...
('eyzenshteyn', 'RU', 33, 'Сергей Эйзенштейн', 'Sergey Eyzenshteyn',
...
('sholohov', 'RU', 33, 'Михаил Шолохов', 'Mixail Sholoxov',
...
('chkalov', 'RU', 33, 'Валерий Чкалов', 'Valeriy Chkalov',
...
('tupolev', 'RU', 33, 'Андрей Туполев', 'Andrey Tupolev',
...
('solzhenitsyn', 'RU', 35, 'Александр Солженицын', 'Aleksandr Soljenitsin',
...
('alferov', 'RU', 35, 'Жорес Алфёров', 'Jores Alfyorov',
...
('ginzburg', 'RU', 35, 'Виталий Гинзбург', 'Vitaliy Ginzburg',
